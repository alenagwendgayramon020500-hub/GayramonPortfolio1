  ...
  void initState() {
    ...
    projects = [
      Project(
        ...
        description:
            'A desktop application built using Python and MySQL that allows teachers to manage student records efficiently.',
        githubUrl: 'https://github.com/yourusername/language-learning',
      ),
      Project(
        title: 'Language Learning Web System',
        description:
            'A web-based platform developed using HTML, CSS, JavaScript, and PHP designed to help students learn new languages interactively.',
        githubUrl: 'https://github.com/yourusername/discrete-math',
      ),
      Project(
        title: 'Personal Portfolio Website',
        description:
            'A responsive personal portfolio website created using ReactJS to showcase projects, skills, and achievements.',
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: widget.themeMode == ThemeMode.dark
                ...
                : [
                    const Color.fromARGB(255, 243, 117, 222),
                    const Color.fromARGB(255, 230, 129, 224),
                  ],
